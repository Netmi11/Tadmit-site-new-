...
const FAQ_ITEMS = [
  ...
  {
    q: 'מה ההבדל בינכם לבין סוכן נדל"ן רגיל?',
    a: 'סוכן נדל"ן מייצג את המוכר - אנחנו מייצגים אתכם בלבד. אין לנו עמלות מיזמים, אין אינטרסים נסתרים. הרווח שלנו הוא ההצלחה שלכם.'
  },
  {
    q: 'איך אתם בוחרים אילו עסקאות להמליץ עליהן?',
    a: 'אנחנו מתמקדים בעסקאות עם רווח משמעותי כבר בשלב הקנייה - לא מסתפקים בקנייה "רגילה". כל נכס עובר ניתוח מלא: שוק, מיקום, פוטנציאל עליית ערך, תשואת שכירות וסיכונים. רק עסקאות שעומדות בקריטריונים שלנו מגיעות אליכם.'
  },
];
